...
export const nav: NavInfo[] =[
  ...
  },
  {
    ...
    sublinks: ["Requirements",]
  },
  {
    name: "Academics",
    heading: "Academics",
    description: "Our academic programs are rigorous and carefully modelled to prepare our students to be ahead.",
    sublinks: ["Faculty of Engineering", "Faculty of Hospitality", "Faculty of Agriculture", "Faculty of Business & Finance", "Faculty of Creative Art", "Faculty of Computer Science"]
  },
];